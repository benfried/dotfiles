...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ac-geiser adoc-mode age async auto-complete cider company
	       ...
	       modus-themes oauth2 org-bullets osx-plist ox-asciidoc
	       ox-clip ox-gfm popup projectile python-environment
	       rainbow-delimiters request sly-repl-ansi-color
	       smartparens solarized-theme swiper transient web-mode
	       websocket with-editor xwwp xwwp-follow-link-helm yaml
	       yaml-mode yasnippet))
