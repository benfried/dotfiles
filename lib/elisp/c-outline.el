Article 3347 of gnu.emacs.sources:
Path: news.columbia.edu!panix!MathWorks.Com!europa.eng.gtefsd.com!howland.reston.ans.net!math.ohio-state.edu!magnus.acs.ohio-state.edu!cis.ohio-state.edu!bartley.demon.co.uk!KevinB
From: KevinB@bartley.demon.co.uk (Kevin Broadey)
Newsgroups: gnu.emacs.sources
Subject: c-outline.el 1.5: outline-minor-mode support for C program editing
Date: 15 Apr 1994 12:33:40 -0400
Organization: Source only  Discussion and requests in gnu.emacs.help.
Lines: 306
Sender: daemon@cis.ohio-state.edu
Distribution: gnu
Message-ID: <9404151214.AA29607@bartley.demon.co.uk>

Just a couple of minor bugfixes since the last one (1.3):-
...
;; Version: c-outline.el 1.5 dated 94/04/15 at 13:11:43
...
;; Date: 94/04/15|Version: 1.5|~/misc/c-outline.el.Z|
  ...
  (let (soh-pos indentation soh-char level)
    ...
    (setq level
	  (cond
	   ...
	   ;; for open braces level is indentation if previous line is blank or
	   ;; is indented more, and is indentation + block offset otherwise
	   ((= soh-char ?{)
	    (goto-char (1- soh-pos))
	    (if (re-search-backward "[\n\^M]" nil 'move)
		(forward-char 1))
